...
const ADDON_PRICE_IDS = {
  // $3/employee/mo on Growth & Business (flat $30/mo on Starter). Keep the
  // preview math in services/billing.js ADDON_MONTHLY in sync with whatever
  // is configured on the Polar price.
  desktop_standard: env('POLAR_ADDON_DESKTOP_STANDARD_PRICE_ID'),
  desktop_founding: env('POLAR_ADDON_DESKTOP_FOUNDING_PRICE_ID'),
};
